...
describe('LatencyAnalyticsController', () => {
  let controller: LatencyAnalyticsController;
  let service: jest.Mocked<Pick<LatencyAnalyticsService, 'getStoredSnapshots'>>;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        { provide: LatencyAnalyticsService, useValue: service },
      ],
    }).compile();

    controller = module.get<LatencyAnalyticsController>(LatencyAnalyticsController);
  });
